...
export function AstronautFinale() {
  ...
  useEffect(() => {
    ...
    const syncVideo = (force = false) => {
      ...
      // The scene plays the reveal whole, from the silhouette. It was briefly
      // started partway in, to share the plate with a chapter above — but the
      // move only reads as a reveal if it begins before there is anything to
      // see, and entering at the half-lit frame threw that away.
